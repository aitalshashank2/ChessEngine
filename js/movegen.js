    ...
    if(GameBoard.side == COLOURS.WHITE){
        ...
        for(pceNum = 0; pceNum < GameBoard.pceNum[pceType]; pceNum++){
            ...
            if(GameBoard.enPas != SQUARES.NO_SQ){
                if(sq + 9 == GameBoard.enPas){
                    AddEnPassantMove(MOVE(sq, sq + 9, PIECES.EMPTY, PIECES.EMPTY, MFLAGEP));//add capture in make move function
                }
        ...
        if(GameBoard.castlePerm & CASTLEBIT.WKCA){
            if(GameBoard.pieces[SQUARES.F1] == PIECES.EMPTY && GameBoard.pieces[SQUARES.G1] == PIECES.EMPTY){
                if(SqAttcked(SQUARES.F1, COLOURS.BLACK) == BOOL.FALSE && SqAttcked(SQUARES.G1, COLOURS.BLACK) == BOOL.FALSE){
                    AddQuietMove(MOVE(SQUARES.E1, SQUARES.G1, PIECES.EMPTY, PIECES.EMPTY, MFLAGCA));
                    //Add rook functionality in make move function
                }
            }
        }
        ...
        if(GameBoard.castlePerm & CASTLEBIT.WQCA){
            if(GameBoard.pieces[SQUARES.B1] == PIECES.EMPTY && GameBoard.pieces[SQUARES.C1] == PIECES.EMPTY && GameBoard.pieces[SQUARES.D1] == PIECES.EMPTY){
                if(SqAttcked(SQUARES.C1, COLOURS.BLACK) == BOOL.FALSE && SqAttcked(SQUARES.D1, COLOURS.BLACK) == BOOL.FALSE && SqAttcked(SQUARES.E1, COLOURS.BLACK) == BOOL.FALSE){
        ...
        if(GameBoard.castlePerm & CASTLEBIT.BKCA){
            if(GameBoard.pieces[SQUARES.F8] == PIECES.EMPTY && GameBoard.pieces[SQUARES.G8] == PIECES.EMPTY){
                if(SqAttcked(SQUARES.F8, COLOURS.WHITE) == BOOL.FALSE && SqAttcked(SQUARES.G8, COLOURS.WHITE) == BOOL.FALSE){
        ...
        if(GameBoard.castlePerm & CASTLEBIT.BQCA){
            if(GameBoard.pieces[SQUARES.B8] == PIECES.EMPTY && GameBoard.pieces[SQUARES.C8] == PIECES.EMPTY && GameBoard.pieces[SQUARES.D8] == PIECES.EMPTY){
                if(SqAttcked(SQUARES.C8, COLOURS.WHITE) == BOOL.FALSE && SqAttcked(SQUARES.D8, COLOURS.WHITE) == BOOL.FALSE && SqAttcked(SQUARES.E8, COLOURS.WHITE) == BOOL.FALSE){
