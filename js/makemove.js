...
function MakeMove(move){
    ...
    if((move & MFLAGEP) != 0){
        ...
        switch(to){
            ...
            default:
                console.log("Invalid position change for king during castling");
                break;
        }
    }
    ...
    if(SqAttcked(GameBoard.pList[PCEINDEX(Kings[side], GameBoard.side)])){
        TakeMove();
        return BOOL.FALSE;
    }
    return BOOL.TRUE;
...
function TakeMove(){
    ...
    if((MFLAGEP & move) != 0){
        ...
        switch(to){
            ...
            default:
                console.log("Error in taking castling move back");
                break;
        }
    }
